...
import com.coursework.conn.ConnectionUtils;
...
public class JDBCFilter implements Filter {
  ...
  private boolean needJDBC(HttpServletRequest request) {
    ...
    Collection<? extends ServletRegistration> values = servletRegistrations.values(); //получить данные об имени хоста, порт и тд
